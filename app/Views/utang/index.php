...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-3">
    ...
    <button class="btn btn-danger" data-toggle="modal" data-target="#modalUtang">
    ...
    <div class="col-md-4 mb-3">
      <div class="card border-left-danger shadow h-100 py-2">
        <div class="card-body">
          ...
          <div class="h5 mb-0 font-weight-bold text-gray-800">¥<?= number_format($total['utang'],0) ?></div>
        </div>
      </div>
    </div>
    <div class="col-md-4 mb-3">
          ...
          <tbody>
            ...
            <?php else: foreach($list as $r): ?>
              <tr>
                ...
                <td>
                  <?= $r['status']==='lunas' ? '<span class="badge badge-success">Lunas</span>' : '<span class="badge badge-warning">Belum Lunas</span>' ?>
                </td>
                <td class="text-right">
                  <?php if($r['status']==='belum'): ?>
                    <a href="<?= site_url('utang/lunas/'.$r['id']) ?>" class="btn btn-xs btn-outline-success">Tandai Lunas</a>
                  <?php endif; ?>
                  <form action="<?= site_url('utang/delete/'.$r['id']) ?>" method="post" class="d-inline" onsubmit="return confirm('Hapus data ini beserta transaksi terkait?')">
                    <?= csrf_field() ?>
...
<!-- MODAL TAMBAH UTANG -->
<div class="modal fade" id="modalUtang" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered">
    <form action="<?= site_url('utang/store') ?>" method="post" class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group"><label>Nama Pemberi</label><input type="text" name="nama" class="form-control" required></div>
