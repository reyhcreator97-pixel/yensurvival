...
INSERT INTO kekayaan_items VALUES ('93','10','uang','BRI','10000.00',NULL,'40000.00','2025-10-18 06:25:38','2025-10-22 22:35:00');
...
INSERT INTO logs VALUES ('91','8','Admin','Backup Database','Admin membuat backup database manual: backup_2025-10-19_03-35-17.sql','::1','Chrome on Windows','2025-10-19 03:35:17');
INSERT INTO logs VALUES ('92','8','Admin','Download Backup','Admin mengunduh file backup: backup_2025-10-19_03-35-17.sql','::1','Chrome on Windows','2025-10-19 03:35:41');
INSERT INTO logs VALUES ('93','8','Admin','Ubah Pengaturan','Admin memperbarui konfigurasi sistem.','::1','Chrome on Windows','2025-10-19 04:02:24');
INSERT INTO logs VALUES ('94','8','Admin','AUTO_BACKUP_ERROR','Gagal membuat backup otomatis: Call to undefined method CodeIgniter\\Database\\MySQLi\\Connection::backup()','::1','Chrome on Windows','2025-10-19 04:08:24');
INSERT INTO logs VALUES ('95','8','Admin','AUTO_BACKUP_SUCCESS','Backup otomatis berhasil: backup_20251019_041518.sql','::1','Chrome on Windows','2025-10-19 04:15:18');
INSERT INTO logs VALUES ('96','8','Admin','Login','User reycreator berhasil login.','::1','Chrome on Windows','2025-10-20 21:07:38');
INSERT INTO logs VALUES ('97','8','Admin','Reset Password','Admin men-reset password user dengan ID: 10 dengan password : user7520','::1','Chrome on Windows','2025-10-20 21:07:50');
INSERT INTO logs VALUES ('98','8','Admin','Logout','User reycreator melakukan logout.','::1','Chrome on Windows','2025-10-20 21:07:56');
INSERT INTO logs VALUES ('99','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-20 21:08:06');
INSERT INTO logs VALUES ('100','8','Admin','Login','User reycreator berhasil login.','::1','Chrome on Windows','2025-10-21 07:06:47');
INSERT INTO logs VALUES ('101','8','Admin','Logout','User reycreator melakukan logout.','::1','Chrome on Windows','2025-10-21 07:08:31');
INSERT INTO logs VALUES ('102','8','Admin','Login','User reycreator berhasil login.','::1','Chrome on Windows','2025-10-21 07:08:38');
INSERT INTO logs VALUES ('103','8','Admin','Reset Password','Admin men-reset password user dengan ID: 10 dengan password : user4724','::1','Chrome on Windows','2025-10-21 07:08:45');
INSERT INTO logs VALUES ('104','8','Admin','Logout','User reycreator melakukan logout.','::1','Chrome on Windows','2025-10-21 07:09:09');
INSERT INTO logs VALUES ('105','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 07:09:14');
INSERT INTO logs VALUES ('106','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 19:56:05');
INSERT INTO logs VALUES ('107','10','User','Logout','User uci melakukan logout.','::1','Chrome on Windows','2025-10-21 20:10:15');
INSERT INTO logs VALUES ('108','8','Admin','Login','User reycreator berhasil login.','::1','Chrome on Windows','2025-10-21 20:13:27');
INSERT INTO logs VALUES ('109','8','Admin','Reset Password','Admin men-reset password user dengan ID: 10 dengan password : user7412','::1','Chrome on Windows','2025-10-21 20:13:32');
INSERT INTO logs VALUES ('110','8','Admin','Logout','User reycreator melakukan logout.','::1','Chrome on Windows','2025-10-21 20:13:40');
INSERT INTO logs VALUES ('111','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 20:13:44');
INSERT INTO logs VALUES ('112','10','User','Logout','User uci melakukan logout.','::1','Chrome on Windows','2025-10-21 20:14:11');
INSERT INTO logs VALUES ('113','8','Admin','Login','User reycreator berhasil login.','::1','Chrome on Windows','2025-10-21 20:19:25');
INSERT INTO logs VALUES ('114','8','Admin','Reset Password','Admin men-reset password user dengan ID: 10 dengan password : user6214','::1','Chrome on Windows','2025-10-21 20:19:45');
INSERT INTO logs VALUES ('115','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 20:20:01');
INSERT INTO logs VALUES ('116','8','Admin','Reset Password','Admin men-reset password user dengan ID: 10 dengan password : user5535','::1','Chrome on Windows','2025-10-21 20:25:43');
INSERT INTO logs VALUES ('117','10','User','Logout','User uci melakukan logout.','::1','Chrome on Windows','2025-10-21 20:25:53');
INSERT INTO logs VALUES ('118','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 20:26:00');
INSERT INTO logs VALUES ('119','10','User','Logout','User uci melakukan logout.','::1','Chrome on Windows','2025-10-21 20:26:21');
INSERT INTO logs VALUES ('120','8','Admin','Reset Password','Admin men-reset password user dengan ID: 10 dengan password : user6015','::1','Chrome on Windows','2025-10-21 20:33:25');
INSERT INTO logs VALUES ('121','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 20:33:38');
INSERT INTO logs VALUES ('122','8','Admin','Login','User reycreator berhasil login.','::1','Chrome on Windows','2025-10-21 22:48:53');
INSERT INTO logs VALUES ('123','8','Admin','Reset Password','Admin men-reset password user dengan ID: 10 dengan password : user9018','::1','Chrome on Windows','2025-10-21 22:48:53');
INSERT INTO logs VALUES ('124','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 22:49:06');
INSERT INTO logs VALUES ('125','10','User','Logout','User uci melakukan logout.','::1','Chrome on Windows','2025-10-21 23:11:51');
INSERT INTO logs VALUES ('126','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 23:11:57');
INSERT INTO logs VALUES ('127','10','User','Logout','User uci melakukan logout.','::1','Chrome on Windows','2025-10-21 23:12:03');
INSERT INTO logs VALUES ('128','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-21 23:12:11');
INSERT INTO logs VALUES ('129','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-22 11:03:44');
INSERT INTO logs VALUES ('130','8','Admin','Login','User reycreator berhasil login.','::1','Chrome on Windows','2025-10-22 11:55:02');
INSERT INTO logs VALUES ('131','10','User','Login','User uci berhasil login.','::1','Chrome on Windows','2025-10-22 18:21:53');
INSERT INTO logs VALUES ('132','8','Admin','Login','User reycreator berhasil login.','::1','Chrome on Windows','2025-10-22 22:57:49');
...
INSERT INTO settings VALUES ('1','¥','600.00','4000.00','daily','+628557663472','2025-10-19 00:19:21','2025-10-19 04:02:24');
...
INSERT INTO subscriptions VALUES ('8','10','monthly','','2025-10-22','2025-11-21','2025-10-22 22:56:57','2025-10-22 22:56:57');
...
INSERT INTO transaksi VALUES ('199','10','2025-10-18','out',NULL,'89',NULL,'Utang','Modal awal dari Utang','pending','10000.00','0','2025-10-18 15:23:28','2025-10-18 15:23:28');
...
INSERT INTO transaksi VALUES ('204','10','2025-10-18','out',NULL,'88','93','Transfer','Transfer keluar','pending','5000.00','0','2025-10-18 15:26:18','2025-10-18 15:26:18');
...
INSERT INTO transaksi VALUES ('206','10','2025-10-18','out',NULL,'88',NULL,'Investasi','Beli investasi: Kartu Pokemon','pending','1000.00','0','2025-10-18 15:27:22','2025-10-18 15:27:22');
...
INSERT INTO transaksi VALUES ('209','10','2025-10-18','out',NULL,'88',NULL,'Aset','Pembelian aset: A','pending','5000.00','0','2025-10-18 15:29:01','2025-10-18 15:29:01');
...
INSERT INTO transaksi VALUES ('213','10','2025-10-18','out',NULL,'88',NULL,'Utang','Pembayaran utang: Bank BCA','pending','10000.00','0','2025-10-18 15:30:30','2025-10-18 15:30:30');
INSERT INTO transaksi VALUES ('214','10','2025-10-18','out',NULL,'88',NULL,'Utang','Pembayaran utang: Orang Tua','pending','10000.00','0','2025-10-18 15:30:41','2025-10-18 15:30:41');
...
INSERT INTO transaksi VALUES ('216','10','2025-10-18','out',NULL,'88',NULL,'Piutang','Memberi Piutang: Bank BCA','pending','10000.00','0','2025-10-18 15:31:08','2025-10-18 15:31:08');
...
INSERT INTO transaksi VALUES ('218','10','2025-10-18','out',NULL,'88','93','Transfer','Transfer keluar','pending','10000.00','0','2025-10-18 15:40:33','2025-10-18 15:40:33');
...
INSERT INTO transaksi VALUES ('224','10','2025-10-22','out',NULL,NULL,NULL,'subscription','Monthly Plan Subscription','pending','600.00','0','2025-10-22 22:56:57','2025-10-22 22:56:57');
